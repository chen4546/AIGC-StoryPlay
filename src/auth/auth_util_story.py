...
def gen_signature(app_sceret, signing_string):
    hash_obj = hmac.new(app_sceret, signing_string, hashlib.sha256)
...
def gen_sign_headers(app_id, app_key, method, uri, query):
    ...
    return {
        ...
        'X-AI-GATEWAY-SIGNATURE': str(signature, encoding='utf-8')
    }
