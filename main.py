...
import winsound
from story_generation import image_draw, story_tell, ai_content_split, sync_vivogpt, load_message_from_json

from prompts.load_prompts import load_prompts
from story_generation import get_path
from function.cv2_to_pixmap import cv2_to_pixmap
...
class GameGUI(QWidget):
    ...
    def init_story(self):
        ...
        self.messages += [system_prompts, start_prompts]
    ...
    def process_ai_response(self, ai_content):
        ...
        # 播放语音
        sound_path = get_path(story_tell(plot), 'sound')
        print(sound_path)
